    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?= $form->field($model, 'group_id', \backend\helper\FormHelper::FormHorizontalFieldOptions)->dropDownList($model->groupDropdownList) ?>
                <?= $form->field($model, 'type_id', \backend\helper\FormHelper::FormHorizontalFieldOptions)->dropDownList($model->typeDropdownList) ?>
                <?= $form->field($model, 'order', \backend\helper\FormHelper::FormHorizontalFieldOptions)->textInput() ?>
            </div>
        </div>
